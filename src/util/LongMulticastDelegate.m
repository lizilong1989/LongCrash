...
@interface LongMulticastDelegateNode : NSObject {
@private
...
@interface LongMulticastDelegate ()
{
...
@interface LongMulticastDelegateEnumerator ()
{
	NSUInteger numNodes;
...
@implementation LongMulticastDelegate
...
- (void)addDelegate:(id)delegate delegateQueue:(dispatch_queue_t)delegateQueue
{
	...
	@synchronized (delegateNodes) {
        LongMulticastDelegateNode *node =
	    [[LongMulticastDelegateNode alloc] initWithDelegate:delegate delegateQueue:delegateQueue];
...
- (void)removeDelegate:(id)delegate delegateQueue:(dispatch_queue_t)delegateQueue
{
    ...
    @synchronized (delegateNodes) {
        ...
        {
            LongMulticastDelegateNode *node = [delegateNodes objectAtIndex:(i-1)];
...
{
    @synchronized (delegateNodes) {
        for (LongMulticastDelegateNode *node in delegateNodes)
        {
            node.delegate = nil;
            #if __has_feature(objc_arc_weak) && !TARGET_OS_IPHONE
            node.unsafeDelegate = nil;
...
- (LongMulticastDelegateEnumerator *)delegateEnumerator
{
	return [[LongMulticastDelegateEnumerator alloc] initFromDelegateNodes:delegateNodes];
}
...
@implementation LongMulticastDelegateNode
...
@implementation LongMulticastDelegateEnumerator
...
- (BOOL)getNextDelegate:(id *)delPtr delegateQueue:(dispatch_queue_t *)dqPtr
{
	...
	{
		LongMulticastDelegateNode *node = [delegateNodes objectAtIndex:currentNodeIndex];
		currentNodeIndex++;
